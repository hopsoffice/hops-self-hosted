...
tmp=$(mktemp -d)
version="0.1"
curl -L "https://github.com/hopsoffice/self-hosted/releases/download/$version/releases$version.tar.gz" > "$tmp/releases$version.tar.gz"
...
echo -e "\t$ ./install.sh"
echo -e "\t$ docker login https://registry.hopsoffice.com"
